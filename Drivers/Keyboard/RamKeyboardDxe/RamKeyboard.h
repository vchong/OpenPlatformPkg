...
#ifndef _RAM_KEYBOARD_H_
#define _RAM_KEYBOARD_H_
...
//
extern EFI_DRIVER_BINDING_PROTOCOL  gRamKeyboardDriverBinding;
extern EFI_COMPONENT_NAME_PROTOCOL  gRamKeyboardComponentName;
extern EFI_COMPONENT_NAME2_PROTOCOL gRamKeyboardComponentName2;


//
// RAM Keyboard Defines
//
...
//
// RAM Keyboard Device Structure
//
#define RAM_KEYBOARD_DEV_SIGNATURE SIGNATURE_32 ('R', 'K', 'B', 'D')
#define RAM_KEYBOARD_CONSOLE_IN_EX_NOTIFY_SIGNATURE SIGNATURE_32 ('r', 'k', 'c', 'n')

typedef struct _RAM_KEYBOARD_CONSOLE_IN_EX_NOTIFY {
  UINTN                                      Signature;
...
#define RAM_KEYBOARD_DEV_FROM_THIS(a)  CR (a, RAM_KEYBOARD_DEV, SimpleTextIn, RAM_KEYBOARD_DEV_SIGNATURE)
#define TEXT_INPUT_EX_RAM_KEYBOARD_DEV_FROM_THIS(a) \
  CR (a, \
      RAM_KEYBOARD_DEV, \
      SimpleTextInputEx, \
      RAM_KEYBOARD_DEV_SIGNATURE \
      )
...
/**
  ...
  @param  Context A RAM_KEYBOARD_DEV pointer
