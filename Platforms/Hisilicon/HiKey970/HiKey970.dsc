...
[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/HiKey970
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = OpenPlatformPkg/Platforms/Hisilicon/HiKey970/HiKey970.fdf
...
!endif
  ...
  ArmPlatformLib|OpenPlatformPkg/Platforms/Hisilicon/HiKey970/Library/HiKey970Lib/HiKey970Lib.inf
...
[BuildOptions]
  GCC:*_*_*_PLATFORM_FLAGS == -I$(WORKSPACE)/MdeModulePkg/Include -I$(WORKSPACE)/OpenPlatformPkg/Include -I$(WORKSPACE)/OpenPlatformPkg/Platforms/Hisilicon/HiKey970/Include -I$(WORKSPACE)/EmbeddedPkg/Include
...
!endif
  ...
  gEmbeddedTokenSpaceGuid.PcdEmbeddedPrompt|"HiKey970"
  ...
  # Ufs
  #
  gDwUfsHcDxeTokenSpaceGuid.PcdDwUfsHcDxeBaseAddress|0xFF3C0000
  gDwUfsHcDxeTokenSpaceGuid.PcdDwUfsHcDxePhy10nm|TRUE
  ...
  gHiKey970TokenSpaceGuid.PcdAndroidFastbootNvmDevicePath|L"VenHw(0D51905B-B77E-452A-A2C0-ECA0CC8D514A,00003CFF0000000000)/UFS(0x0,0x3)"
  # Flash limit 128M/time, for memory concern
  gHiKey970TokenSpaceGuid.PcdArmFastbootFlashLimit|"134217728"
  gHiKey970TokenSpaceGuid.PcdXloaderDevicePath|L"VenHw(0D51905B-B77E-452A-A2C0-ECA0CC8D514A,00003CFF0000000000)/UFS(0x0,0x0)"

  #
  # Android Loader
  #
  gEmbeddedTokenSpaceGuid.PcdAndroidBootDevicePath|L"VenHw(0D51905B-B77E-452A-A2C0-ECA0CC8D514A,00003CFF0000000000)/UFS(0x0,0x3)/HD(7,GPT,D3340696-9B95-4C64-8DF6-E6D4548FBA41,0x12100,0x5000)"
...
[Components.common]
  ...
  # GPIO
  #
  OpenPlatformPkg/Platforms/Hisilicon/HiKey970/HiKey970GpioDxe/HiKey970GpioDxe.inf
  ...
  # MMC/SD
  #
  OpenPlatformPkg/Platforms/Hisilicon/HiKey970/HiKey970MmcDxe/HiKey970MmcDxe.inf
  MdeModulePkg/Bus/Pci/NonDiscoverablePciDeviceDxe/NonDiscoverablePciDeviceDxe.inf
  OpenPlatformPkg/Drivers/SdMmc/DwMmcHcDxe/DwMmcHcDxe.inf
  MdeModulePkg/Bus/Sd/SdDxe/SdDxe.inf

  OpenPlatformPkg/Platforms/Hisilicon/HiKey970/HiKey970Dxe/HiKey970Dxe.inf
  ...
  #
  OpenPlatformPkg/Platforms/Hisilicon/HiKey970/HiKey970UsbDxe/HiKey970UsbDxe.inf
  OpenPlatformPkg/Drivers/Usb/DwUsb3Dxe/DwUsb3Dxe.inf
  OpenPlatformPkg/Platforms/Hisilicon/HiKey970/HiKey970FastbootDxe/HiKey970FastbootDxe.inf
